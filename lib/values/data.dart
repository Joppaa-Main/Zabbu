...
class Data {
  ...
  static List<PortfolioData> portfolioData = [
    PortfolioData(
      images: [ImagePath.ONBOARDING_APP ] ,
      ...
      imageSize: 0.15,
      isPublic: true,
      technologyUsed: StringConst.MARKETING_STACK,
      // gitHubUrl: StringConst.FOODY_BITE_GITHUB_URL,
    ),
    PortfolioData(
      //Love Cafe
      images: [ImagePath.OTP_TEXT_FIELD ],
    ...
    PortfolioData(
      //Cooled
      images: [ImagePath.LOGIN_CATALOG ],
    ...
    PortfolioData(
      ...
      imageSize: 0.45,
      isPublic: true,
      technologyUsed: StringConst.SOFT_STACK_NODEJS,
      // gitHubUrl: StringConst.FOODY_BITE_GITHUB_URL,
    ),
    PortfolioData(
      // Nigerian HQ
       images: [ImagePath.FINOPP ],
    ...
    PortfolioData(
      //DriversBase
       images: [ImagePath.COLOSSAL_TOONS ],
