...
class AppColors {
  ...
  static const Color primaryColor = Color.fromARGB(251, 255, 199, 87);
  static const Color secondaryColor = Color.fromARGB(255, 21, 21, 21);
  ...
  static const Color complimentColor1 = Color.fromARGB(248, 119, 207, 123);
  static const Color complimentColor2 = Color.fromARGB(255, 255, 255, 255);
...
//  static const Color accentColor2 = Color(0xFF000000);
  ...
  static const Color cream = Color.fromARGB(92, 255, 199, 87);
  static const Color cream500 = Color.fromARGB(73, 255, 199, 87);
...
//  static const Color cream700 = Color(0xFFB5B8BC);
  ...
  static const Color bodyText1 = Color(0xFF000000);
